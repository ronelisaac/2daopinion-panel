...
3. E2-24 añade clasificación administrativa por specialtyId desde el detalle de Solicitudes: Operaciones registra origen confirmado o mantiene pendiente, con revisión/auditoría y validación del catálogo. No equivale a derivación médica validada ni publica el catálogo al paciente. E2-25 activa la asignación administrativa; los permisos clínicos por caso siguen pendientes. No depende de una clínica. No inferir especialidad del texto privado ni tratar disponibilidad como autorización clínica. Definir precondiciones de documentación, consentimiento y pago, exclusividad, aceptación/rechazo y reasignación.
4. E2-25 entrega asignación administrativa pendiente de aceptación, con médico elegible, bloqueo de reclasificación, liberación y reasignación. Siguiente: aceptación/rechazo por el médico y luego permisos clínicos con sus precondiciones. Afiliaciones opcionales a clínicas más adelante; sin forzar exclusividad ni convenios.
