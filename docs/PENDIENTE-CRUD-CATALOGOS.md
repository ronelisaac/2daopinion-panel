...
E2-15 entrega registro/corrección/revisión manual de médicos en desarrollo; no un CRUD completo con eliminación. [E2-17](E2-17-ESPECIALIDADES-FIREBASE.md) activa especialidades con baja lógica, validaciones y auditoría en Firebase remoto; superadmin administra y Operaciones/Dirección médica consultan por país. Conexión de selectores y clínicas pendientes. La política vigente autoriza publicar secciones verificadas de desarrollo sin nueva confirmación rutinaria; no ampliar roles reales ni habilitar atención clínica por inferencia.
